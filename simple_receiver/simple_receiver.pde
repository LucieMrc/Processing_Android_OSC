...
void draw() {
  ...
  fill(0);
  text("hslider 1 :  "+hsl1, 20,80);
  
  text("vslider 1 :  "+vsl1, 20,100);

  text("touch x :  "+w, 20,140);
  
  text("touch y :  "+h, 20,160);
  
  text("hradio 1 :  "+hrd1, 20,200);
  
  text("vradio 1 :  "+vrd1, 20,220);
